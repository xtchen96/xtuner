...
#             init_kwargs=dict(project="xtuner", entity='alpaca_phi3-4b_w_fa_dsz3'),
#         )
#     ],
...
visualizer=dict(type='Visualizer',
                vis_backends=[dict(type='WandbVisBackend', init_kwargs=dict(project="xtuner", name='alpaca_phi3-4b_w_fa_dsz3'))],
                save_dir="/data/home/xiaotong/xtuner/runs/wandb")
